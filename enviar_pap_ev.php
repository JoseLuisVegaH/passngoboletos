...
if(isset($_POST['sent'])) {
  ...
  if(!isset($error)) {
    ...
    $queryAddEvento = sprintf("INSERT INTO papeleraevento (nombre, tipo, artistaOGrupo, fecha, hora, lugar, localidad, descripcion, imagen, numBoletos, precio, precioVip, latitud, longitud) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')",
